...
export const Footer: React.FC = () => {
  return (
    <footer id="contact" className="relative z-20 bg-white/80 backdrop-blur-sm border-t border-brand-navy/5 py-20">
      <div className="max-w-6xl mx-auto px-6 md:px-12">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
          <div>
            <div className="flex items-center gap-2 mb-6">
                <span className="text-2xl font-black tracking-tight text-brand-navy italic" style={{ fontFamily: 'Inter, sans-serif', transform: 'skewX(-6deg)' }}>
                  FELJI
                </span>
          ...
          <div className="md:text-right">
            ...
            <a 
              ...
              className="text-2xl md:text-3xl font-bold text-brand-navy hover:text-brand-green transition-colors"
            >
              felji.org@gmail.com
            </a>
            <p className="text-zinc-400 mt-4 font-light">
              Talibon, Bohol
            </p>
          </div>
        </div>
