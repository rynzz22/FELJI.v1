...
export const TechBackground: React.FC = () => {
  ...
  return (
    <div className="fixed inset-0 z-0 pointer-events-none overflow-hidden bg-zinc-50/50">
      {/* Soft Grid */}
      ...
      <div className="absolute top-[-10%] right-[-10%] w-[800px] h-[800px] bg-brand-navy/5 rounded-full blur-[100px] animate-pulse-slow"></div>
      <div className="absolute bottom-[-10%] left-[-10%] w-[700px] h-[700px] bg-brand-green/10 rounded-full blur-[100px] animate-pulse-slow [animation-delay:2s]"></div>
      <div className="absolute top-[40%] left-[20%] w-[600px] h-[600px] bg-blue-100/30 rounded-full blur-[80px] animate-pulse-slow [animation-delay:4s]"></div>
      ...
      <div ref={shape1Ref} className="absolute top-32 left-[10%] w-48 h-48 opacity-80 mix-blend-normal will-change-transform">
         <div className="w-full h-full animate-blob">
            <div className="w-full h-full rounded-[40%_60%_70%_30%/40%_50%_60%_50%] bg-gradient-to-br from-white/40 to-white/5 border border-white/60 backdrop-blur-[8px] shadow-lg shadow-zinc-200/20"></div>
         </div>
      </div>
      ...
      <div ref={shape2Ref} className="absolute bottom-1/4 right-[5%] w-64 h-64 opacity-70 will-change-transform">
         <div className="w-full h-full animate-float [animation-delay:1s]">
            <div className="w-full h-full rounded-full bg-gradient-to-tr from-white/40 via-white/10 to-transparent border border-white/50 backdrop-blur-[6px] shadow-xl shadow-brand-navy/5"></div>
            {/* Highlight reflection */}
            <div className="absolute top-[15%] right-[15%] w-12 h-12 bg-white/40 rounded-full blur-xl"></div>
         </div>
      </div>
      ...
      <div ref={shape3Ref} className="absolute top-[60%] left-[5%] w-40 h-40 opacity-60 will-change-transform">
         <div className="w-full h-full animate-blob [animation-delay:3s]">
            <div className="w-full h-full rounded-[30%_70%_70%_30%/30%_30%_70%_70%] bg-white/10 border border-white/40 backdrop-blur-[4px]"></div>
         </div>
      </div>
      ...
      <div ref={shape4Ref} className="absolute top-[20%] right-[30%] w-12 h-12 will-change-transform">
        <div className="w-full h-full animate-float [animation-delay:1.5s]">
           <div className="w-full h-full rounded-full bg-white/20 border border-white/40 backdrop-blur-[2px]"></div>
        </div>
      </div>
      ...
      <div ref={shape5Ref} className="absolute bottom-[20%] left-[40%] w-8 h-8 will-change-transform">
        <div className="w-full h-full animate-float [animation-delay:3.5s]">
           <div className="w-full h-full rounded-full bg-brand-green/10 border border-white/30 backdrop-blur-[2px]"></div>
        </div>
      </div>
      ...
      <div ref={shape6Ref} className="absolute top-1/4 right-[20%] w-56 h-56 opacity-50 will-change-transform">
        <div className="w-full h-full animate-blob [animation-delay:5s]">
          <div className="w-full h-full rounded-[50%_50%_40%_60%/50%_50%_60%_40%] bg-gradient-to-b from-white/30 to-transparent border border-white/30 backdrop-blur-[10px] shadow-lg"></div>
        </div>
      </div>
